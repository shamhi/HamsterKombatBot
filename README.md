...
| **APPLY_PROMO_CODES**        | Использовать ли активацию промокодов _(True / False)_                                         |
| **APPLY_DAILY_CIPHER**       | Использовать ли ввод ежедневного шифра _(True / False)_                                       |
| **APPLY_DAILY_REWARD**       | Использовать ли сбор ежедневной награды _(True / False)_                                      |
| **APPLY_DAILY_ENERGY**       | Использовать ли активацию ежедневного буста энергии _(True / False)_                          |
| **APPLY_DAILY_MINI_GAME**    | Использовать ли активацию мини игры _(True / False)_                                          |
